...
<template>
  <div class="rounded-2xl border mx-0 md:mx-8 p-6 shadow-sm sm:p-10 border-zinc-800 bg-zinc-900">
    <div class="space-y-6 leading-relaxed text-gray-400">
      ...
      <section class="space-y-3">
        <h3 id="m716" class="scroll-mt-6 text-xl font-semibold text-white">
          Präambel
        </h3>
        <p>
        ...
        <p class="text-sm text-gray-400">Stand: 30. August 2024</p>
      </section>

      <!-- Inhaltsübersicht -->
      <section class="rounded-xl border p-5 border-zinc-800 bg-zinc-800/50">
        <h3 class="mb-3 text-lg font-semibold text-white">
          Inhaltsübersicht
        </h3>
        <ul class="grid grid-cols-1 gap-2 text-sm sm:grid-cols-2">
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m716">Präambel</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m3">Verantwortlicher</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#mOverview">Übersicht der Verarbeitungen</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m2427">Maßgebliche Rechtsgrundlagen</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m27">Sicherheitsmaßnahmen</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m25">Übermittlung von personenbezogenen Daten</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m24">Internationale Datentransfers</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m12">Allgemeine Informationen zur Datenspeicherung und Löschung</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m10">Rechte der betroffenen Personen</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m317">Geschäftliche Leistungen</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m605">Einsatz von Online-Plattformen zu Angebots- und Vertriebszwecken</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m225">Bereitstellung des Onlineangebots und Webhosting</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m134">Einsatz von Cookies</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m104">Blogs und Publikationsmedien</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m237">Gewinnspiele und Wettbewerbe</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m408">Umfragen und Befragungen</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m263">Webanalyse, Monitoring und Optimierung</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m264">Onlinemarketing</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m135">Affiliate-Programme und Affiliate-Links</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m136">Präsenzen in sozialen Netzwerken (Social Media)</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m328">Plug-ins und eingebettete Funktionen sowie Inhalte</a></li>
          <li><a class="text-blue-400 underline-offset-2 hover:underline" href="#m15">Änderung und Aktualisierung</a></li>
        </ul>
      </section>

      <!-- Verantwortlicher -->
      <section class="space-y-2">
        <h3 id="m3" class="scroll-mt-6 text-xl font-semibold text-white">
          Verantwortlicher
        </h3>
        <p>
          Daniel Niesmann<br>
          Querstraße 10, 31073 Delligsen<br>
          Deutschland, Niedersachsen
        </p>
        <p>
          E-Mail: <a class="text-blue-400 underline-offset-2 hover:underline" href="mailto:daniel.niesmann@outlook.com">daniel.niesmann@outlook.com</a>
        </p>
      </section>

      <!-- Übersicht der Verarbeitungen -->
      <section class="space-y-4">
        <h3 id="mOverview" class="scroll-mt-6 text-xl font-semibold text-white">
          Übersicht der Verarbeitungen
        </h3>
        <p>Die nachfolgende Übersicht fasst die Arten der verarbeiteten Daten und die Zwecke ihrer Verarbeitung zusammen und verweist auf die betroffenen Personen.</p>

        <div class="space-y-2">
          <h4 class="font-semibold text-white">Arten der verarbeiteten Daten</h4>
        ...
        <div class="space-y-2">
          <h4 class="font-semibold text-white">Kategorien betroffener Personen</h4>
          <ul class="list-inside list-disc space-y-1 pl-2">
        ...
        <div class="space-y-2">
          <h4 class="font-semibold text-white">Zwecke der Verarbeitung</h4>
          <ul class="list-inside list-disc space-y-1 pl-2">
      ...
      <section class="space-y-3">
        <h3 id="m2427" class="scroll-mt-6 text-xl font-semibold text-white">
          Maßgebliche Rechtsgrundlagen
        </h3>
      ...
      <section class="space-y-3">
        <h3 id="m27" class="scroll-mt-6 text-xl font-semibold text-white">
          Sicherheitsmaßnahmen
        </h3>
      ...
      <section class="space-y-3">
        <h3 id="m25" class="scroll-mt-6 text-xl font-semibold text-white">
          Übermittlung von personenbezogenen Daten
        </h3>
      ...
      <section class="space-y-3">
        ...
        <p class="font-semibold text-white">Weitere Hinweise zu Verarbeitungsprozessen, Verfahren und Diensten:</p>
        <ul class="list-inside list-disc space-y-2 pl-2">
          <li><strong>Aufbewahrung und Löschung von Daten: </strong>Die folgenden allgemeinen Fristen gelten für die Aufbewahrung und Archivierung nach deutschem Recht:
            <ul class="mt-2 list-inside list-circle space-y-1 pl-4">
      ...
      <section class="space-y-3">
        <h3 id="m10" class="scroll-mt-6 text-xl font-semibold text-white">
          Rechte der betroffenen Personen
        </h3>
      ...
      <section class="space-y-3">
        <h3 id="m317" class="scroll-mt-6 text-xl font-semibold text-white">
          Geschäftliche Leistungen
        </h3>
        ...
        <p class="font-semibold text-white">Weitere Hinweise zu Verarbeitungsprozessen, Verfahren und Diensten:</p>
        <ul class="list-inside list-disc space-y-3 pl-2">
      ...
      <!-- Online-Plattformen -->
      <section class="space-y-3">
        <h3 id="m605" class="scroll-mt-6 text-xl font-semibold text-white">
        ...
        <ul class="list-inside list-disc space-y-1 pl-2">
          ...
          <li><strong>Betroffene Personen:</strong> Leistungsempfänger und Auftraggeber; Geschäfts- und Vertragspartner. Nutzer (z. B. Webseitenbesucher, Nutzer von Onlinediensten).</li>
          <li><strong>Zwecke der Verarbeitung:</strong> Erbringung vertraglicher Leistungen und Erfüllung vertraglicher Pflichten; Marketing; Geschäftsprozesse und betriebswirtschaftliche Verfahren. Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit.</li>
          <li><strong>Aufbewahrung und Löschung:</strong> Löschung entsprechend Angaben im Abschnitt "Allgemeine Informationen zur Datenspeicherung und Löschung".</li>
          <li><strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO). Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</li>
        </ul>
        <p class="font-semibold text-white">Weitere Hinweise zu Verarbeitungsprozessen, Verfahren und Diensten:</p>
        <ul class="list-inside list-disc space-y-1 pl-2">
          <li><strong>Patreon: </strong>Internetplattform zur Projektfinanzierung über Crowdfunding sowie den Verkauf von Abonnements und Mitgliedschaften, die Abrechnung sowie die Bereitstellung von Zugangs- und Bezahlverfahren, zu deren Durchführung Cookies eingesetzt und die IP-Adresse, Datum, Uhrzeit und weitere technische Daten über den verwendeten Internetbrowser, das Betriebssystem sowie Bestands-, Vertrags- und Zahlungsdaten der Nutzer verarbeitet werden; <strong>Dienstanbieter:</strong> Patreon Irland Limited, German Branch Revaler Strasse 99, Hall 20, 2nd floor Rooms 3.19 and 3.25. 10245 Berlin-Friedrichshain, Deutschland; <span><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); </span><strong>Website:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://www.patreon.com/de-DE" target="_blank" rel="noopener noreferrer">https://www.patreon.com/de-DE</a>. <strong>Datenschutzerklärung:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://privacy.patreon.com/policies" target="_blank" rel="noopener noreferrer">https://privacy.patreon.com/policies</a>.</li>
        </ul>
      </section>

      <!-- Bereitstellung & Hosting -->
      <section class="space-y-3">
        <h3 id="m225" class="scroll-mt-6 text-xl font-semibold text-white">
      ...
      <!-- Cookies -->
      <section class="space-y-3">
        <h3 id="m134" class="scroll-mt-6 text-xl font-semibold text-white">
          Einsatz von Cookies
        </h3>
      ...
      <section class="space-y-3">
        <h3 id="m104" class="scroll-mt-6 text-xl font-semibold text-white">
        ...
        <ul class="list-inside list-disc space-y-1 pl-2">
          ...
          <li><strong>Betroffene Personen:</strong> Nutzer (z. B. Webseitenbesucher, Nutzer von Onlinediensten).</li>
          <li><strong>Zwecke der Verarbeitung:</strong> Feedback (z. B. Sammeln von Feedback via Online-Formular). Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit.</li>
          <li><strong>Aufbewahrung und Löschung:</strong> Löschung entsprechend Angaben im Abschnitt "Allgemeine Informationen zur Datenspeicherung und Löschung".</li>
          <li><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</li>
        </ul>
      </section>
      ...
      <!-- Gewinnspiele -->
      <section class="space-y-3">
        <h3 id="m237" class="scroll-mt-6 text-xl font-semibold text-white">
      ...
      <!-- Umfragen -->
      <section class="space-y-3">
        <h3 id="m408" class="scroll-mt-6 text-xl font-semibold text-white">
      ...
      <!-- Webanalyse -->
      <section class="space-y-3">
        <h3 id="m263" class="scroll-mt-6 text-xl font-semibold text-white">
        ...
        <p class="font-semibold text-white">Weitere Hinweise zu Verarbeitungsprozessen, Verfahren und Diensten:</p>
        <ul class="list-inside list-disc space-y-1 pl-2">
          <li><strong>Google Analytics: </strong>Wir verwenden Google Analytics zur Messung und Analyse der Nutzung unseres Onlineangebotes auf der Grundlage einer pseudonymen Nutzeridentifikationsnummer. Diese Identifikationsnummer enthält keine eindeutigen Daten, wie Namen oder E-Mail-Adressen. Sie dient dazu, Analyseinformationen einem Endgerät zuzuordnen, um zu erkennen, welche Inhalte die Nutzer innerhalb eines oder verschiedener Nutzungsvorgänge aufgerufen haben, welche Suchbegriffe sie verwendet haben, diese erneut aufgerufen haben oder mit unserem Onlineangebot interagiert haben. Ebenso werden der Zeitpunkt der Nutzung und deren Dauer gespeichert, sowie die Quellen der Nutzer, die auf unser Onlineangebot verweisen und technische Aspekte ihrer Endgeräte und Browser.<br>Dabei werden pseudonyme Profile von Nutzern mit Informationen aus der Nutzung verschiedener Geräte erstellt, wobei Cookies eingesetzt werden können. Google Analytics protokolliert und speichert keine individuellen IP-Adressen für EU-Nutzer. Analytics stellt jedoch grobe geografische Standortdaten bereit, indem es die folgenden Metadaten von IP-Adressen ableitet: Stadt (und der abgeleitete Breiten- und Längengrad der Stadt), Kontinent, Land, Region, Subkontinent (und ID-basierte Gegenstücke). Beim EU-Datenverkehr werden die IP-Adressdaten ausschließlich für diese Ableitung von Geolokalisierungsdaten verwendet, bevor sie sofort gelöscht werden. Sie werden nicht protokolliert, sind nicht zugänglich und werden nicht für weitere Verwendungszwecke genutzt. Wenn Google Analytics Messdaten sammelt, werden alle IP-Abfragen auf EU-basierten Servern durchgeführt, bevor der Verkehr zur Verarbeitung an Analytics-Server weitergeleitet wird; <strong>Dienstanbieter:</strong> Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland; <span><strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6 Abs. 1 S. 1 lit. a) DSGVO); </span><strong>Website:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://marketingplatform.google.com/intl/de/about/analytics/" target="_blank" rel="noopener noreferrer">https://marketingplatform.google.com/intl/de/about/analytics/</a>; <strong>Sicherheitsmaßnahmen:</strong> IP-Masking (Pseudonymisierung der IP-Adresse); <strong>Datenschutzerklärung:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy</a>; <strong>Auftragsverarbeitungsvertrag:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://business.safety.google/adsprocessorterms/" target="_blank" rel="noopener noreferrer">https://business.safety.google/adsprocessorterms/</a>; <strong>Grundlage Drittlandtransfers:</strong> Data Privacy Framework (DPF); <strong>Widerspruchsmöglichkeit (Opt-Out):</strong> Opt-Out-Plugin: <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://tools.google.com/dlpage/gaoptout?hl=de" target="_blank" rel="noopener noreferrer">https://tools.google.com/dlpage/gaoptout?hl=de</a>, Einstellungen für die Darstellung von Werbeeinblendungen: <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://myadcenter.google.com/personalizationoff" target="_blank" rel="noopener noreferrer">https://myadcenter.google.com/personalizationoff</a>. <strong>Weitere Informationen:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://business.safety.google/adsservices/" target="_blank" rel="noopener noreferrer">https://business.safety.google/adsservices/</a> (Arten der Verarbeitung sowie der verarbeiteten Daten).</li>
        </ul>
      </section>

      <!-- Onlinemarketing -->
      <section class="space-y-3">
        <h3 id="m264" class="scroll-mt-6 text-xl font-semibold text-white">
          Onlinemarketing
        </h3>
        ...
        <ul class="list-inside list-disc space-y-1 pl-2">
          <li>a) Europa: <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://www.youronlinechoices.eu" target="_blank" rel="noopener noreferrer">https://www.youronlinechoices.eu.</a></li>
          <li>b) Kanada: <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://www.youradchoices.ca/choices" target="_blank" rel="noopener noreferrer">https://www.youradchoices.ca/choices.</a></li>
          <li>c) USA: <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://www.aboutads.info/choices" target="_blank" rel="noopener noreferrer">https://www.aboutads.info/choices.</a></li>
          <li>d) Gebietsübergreifend: <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://optout.aboutads.info" target="_blank" rel="noopener noreferrer">https://optout.aboutads.info.</a></li>
        </ul>
        <ul class="list-inside list-disc space-y-1 pl-2">
          <li><strong>Verarbeitete Datenarten:</strong> Nutzungsdaten (z. B. Seitenaufrufe und Verweildauer, Klickpfade, Nutzungsintensität und -frequenz, verwendete Gerätetypen und Betriebssysteme, Interaktionen mit Inhalten und Funktionen). Meta-, Kommunikations- und Verfahrensdaten (z. B. IP-Adressen, Zeitangaben, Identifikationsnummern, beteiligte Personen).</li>
          <li><strong>Betroffene Personen:</strong> Nutzer (z. B. Webseitenbesucher, Nutzer von Onlinediensten).</li>
          <li><strong>Zwecke der Verarbeitung:</strong> Reichweitenmessung (z. B. Zugriffsstatistiken, Erkennung wiederkehrender Besucher); Tracking (z. B. interessens-/verhaltensbezogenes Profiling, Nutzung von Cookies); Zielgruppenbildung; Marketing; Profile mit nutzerbezogenen Informationen (Erstellen von Nutzerprofilen). Konversionsmessung (Messung der Effektivität von Marketingmaßnahmen).</li>
          <li><strong>Aufbewahrung und Löschung:</strong> Löschung entsprechend Angaben im Abschnitt "Allgemeine Informationen zur Datenspeicherung und Löschung". Speicherung von Cookies von bis zu 2 Jahren (Sofern nicht anders angegeben, können Cookies und ähnliche Speichermethoden für einen Zeitraum von zwei Jahren auf den Geräten der Nutzer gespeichert werden.).</li>
          <li><strong>Sicherheitsmaßnahmen:</strong> IP-Masking (Pseudonymisierung der IP-Adresse).</li>
          <li><strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6 Abs. 1 S. 1 lit. a) DSGVO). Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</li>
        </ul>
      ...
      <!-- Affiliate -->
      <section class="space-y-3">
        <h3 id="m135" class="scroll-mt-6 text-xl font-semibold text-white">
      ...
      <!-- Social Media -->
      <section class="space-y-3">
        <h3 id="m136" class="scroll-mt-6 text-xl font-semibold text-white">
        ...
        <ul class="list-inside list-disc space-y-1 pl-2">
          <li><strong>Verarbeitete Datenarten:</strong> Kontaktdaten (z. B. Post- und E-Mail-Adressen oder Telefonnummern); Inhaltsdaten (z. B. textliche oder bildliche Nachrichten und Beiträge sowie die sie betreffenden Informationen, wie z. B. Angaben zur Autorenschaft oder Zeitpunkt der Erstellung); Nutzungsdaten (z. B. Seitenaufrufe und Verweildauer, Klickpfade, Nutzungsintensität und -frequenz, verwendete Gerätetypen und Betriebssysteme, Interaktionen mit Inhalten und Funktionen); Bestandsdaten (z. B. der vollständige Name, Wohnadresse, Kontaktinformationen, Kundennummer, etc.). Meta-, Kommunikations- und Verfahrensdaten (z. B. IP-Adressen, Zeitangaben, Identifikationsnummern, beteiligte Personen).</li>
          <li><strong>Betroffene Personen:</strong> Nutzer (z. B. Webseitenbesucher, Nutzer von Onlinediensten).</li>
          <li><strong>Zwecke der Verarbeitung:</strong> Kommunikation; Feedback (z. B. Sammeln von Feedback via Online-Formular); Öffentlichkeitsarbeit; Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit; Informationstechnische Infrastruktur (Betrieb und Bereitstellung von Informationssystemen und technischen Geräten (Computer, Server etc.).). Öffentlichkeitsarbeit und Informationszwecke.</li>
          <li><strong>Aufbewahrung und Löschung:</strong> Löschung entsprechend Angaben im Abschnitt "Allgemeine Informationen zur Datenspeicherung und Löschung".</li>
          <li><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</li>
        </ul>
        <p class="font-semibold text-white">Weitere Hinweise zu Verarbeitungsprozessen, Verfahren und Diensten:</p>
        <ul class="list-inside list-disc space-y-3 pl-2">
          <li><strong>Bluesky: </strong>Dezentralisiertes Social-Media-Netzwerk - ermöglicht das Erstellen, Teilen und Kommentieren von Inhalten sowie das Folgen von Nutzerprofilen; <strong>Dienstanbieter:</strong> Bluesky, PBLLC., Seattle, USA, <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="mailto://support@bsky.app">support@bsky.app</a>; <span><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); </span><strong>Website:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://bsky.social/" target="_blank" rel="noopener noreferrer">https://bsky.social/</a>. <strong>Datenschutzerklärung:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://bsky.social/about/support/privacy-policy" target="_blank" rel="noopener noreferrer">https://bsky.social/about/support/privacy-policy</a>.</li>
          <li><strong>Instagram: </strong>Soziales Netzwerk, ermöglicht das Teilen von Fotos und Videos, das Kommentieren und Favorisieren von Beiträgen, Nachrichtenversand, Abonnieren von Profilen und Seiten; <strong>Dienstanbieter:</strong> Meta Platforms Ireland Limited, Merrion Road, Dublin 4, D04 X2K5, Irland; <span><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); </span><strong>Website:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">https://www.instagram.com</a>; <strong>Datenschutzerklärung:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://privacycenter.instagram.com/policy/" target="_blank" rel="noopener noreferrer">https://privacycenter.instagram.com/policy/</a>. <strong>Grundlage Drittlandtransfers:</strong> Data Privacy Framework (DPF).</li>
          <li><strong>Threads: </strong>Soziales Netzwerk; <strong>Dienstanbieter:</strong> Meta Platforms Ireland Limited, Merrion Road, Dublin 4, D04 X2K5, Irland; <span><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); </span><strong>Website:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://www.threads.net/" target="_blank" rel="noopener noreferrer">https://www.threads.net/</a>. <strong>Datenschutzerklärung:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://help.instagram.com/515230437301944" target="_blank" rel="noopener noreferrer">https://help.instagram.com/515230437301944</a>.</li>
          <li><strong>X: </strong>Soziales Netzwerk; <strong>Dienstanbieter:</strong> Twitter International Company, One Cumberland Place, Fenian Street, Dublin 2 D02 AX07, Irland; <span><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); </span><strong>Website:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://x.com" target="_blank" rel="noopener noreferrer">https://x.com</a>. <strong>Datenschutzerklärung:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://x.com/de/privacy" target="_blank" rel="noopener noreferrer">https://x.com/de/privacy</a>.</li>
          <li><strong>YouTube: </strong>Soziales Netzwerk und Videoplattform; <strong>Dienstanbieter:</strong> Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland; <span><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); </span><strong>Datenschutzerklärung:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy</a>; <strong>Grundlage Drittlandtransfers:</strong> Data Privacy Framework (DPF). <strong>Widerspruchsmöglichkeit (Opt-Out):</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://myadcenter.google.com/personalizationoff" target="_blank" rel="noopener noreferrer">https://myadcenter.google.com/personalizationoff</a>.</li>
        </ul>
      </section>

      <!-- Plug-ins -->
      <section class="space-y-3">
        <h3 id="m328" class="scroll-mt-6 text-xl font-semibold text-white">
        ...
        <ul class="list-inside list-disc space-y-1 pl-2">
          <li><strong>Verarbeitete Datenarten:</strong> Nutzungsdaten (z. B. Seitenaufrufe und Verweildauer, Klickpfade, Nutzungsintensität und -frequenz, verwendete Gerätetypen und Betriebssysteme, Interaktionen mit Inhalten und Funktionen); Meta-, Kommunikations- und Verfahrensdaten (z. B. IP-Adressen, Zeitangaben, Identifikationsnummern, beteiligte Personen); Bestandsdaten (z. B. der vollständige Name, Wohnadresse, Kontaktinformationen, Kundennummer, etc.); Kontaktdaten (z. B. Post- und E-Mail-Adressen oder Telefonnummern). Inhaltsdaten (z. B. textliche oder bildliche Nachrichten und Beiträge sowie die sie betreffenden Informationen, wie z. B. Angaben zur Autorenschaft oder Zeitpunkt der Erstellung).</li>
          <li><strong>Betroffene Personen:</strong> Nutzer (z. B. Webseitenbesucher, Nutzer von Onlinediensten).</li>
        ...
        <p class="font-semibold text-white">Weitere Hinweise zu Verarbeitungsprozessen, Verfahren und Diensten:</p>
        <ul class="list-inside list-disc space-y-3 pl-2">
          <li><strong>Einbindung von Drittsoftware, Skripten oder Frameworks (z. B. jQuery): </strong>Wir binden in unser Onlineangebot Software ein, die wir von Servern anderer Anbieter abrufen (z. B. Funktions-Bibliotheken, die wir zwecks Darstellung oder Nutzerfreundlichkeit unseres Onlineangebotes verwenden). Hierbei erheben die jeweiligen Anbieter die IP-Adresse der Nutzer und können diese zu Zwecken der Übermittlung der Software an den Browser der Nutzer sowie zu Zwecken der Sicherheit, als auch zur Auswertung und Optimierung ihres Angebotes verarbeiten. - Wir binden in unser Onlineangebot Software ein, die wir von Servern anderer Anbieter abrufen (z. B. Funktions-Bibliotheken, die wir zwecks Darstellung oder Nutzerfreundlichkeit unseres Onlineangebotes verwenden). Hierbei erheben die jeweiligen Anbieter die IP-Adresse der Nutzer und können diese zu Zwecken der Übermittlung der Software an den Browser der Nutzer sowie zu Zwecken der Sicherheit, als auch zur Auswertung und Optimierung ihres Angebotes verarbeiten; <span><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</span></li>
          <li><strong>Instagram-Plugins und -Inhalte: </strong>Instagram Plugins und -Inhalte - Hierzu können z. B. Inhalte wie Bilder, Videos oder Texte und Schaltflächen gehören, mit denen Nutzer Inhalte dieses Onlineangebotes innerhalb von Instagram teilen können. - Wir sind gemeinsam mit Meta Platforms Ireland Limited für die Erhebung oder den Erhalt im Rahmen einer Übermittlung (jedoch nicht die weitere Verarbeitung) von "Event-Daten", die Facebook mittels Funktionen von Instagram (z. B. Einbettungsfunktionen für Inhalte), die auf unserem Onlineangebot ausgeführt werden, erhebt oder im Rahmen einer Übermittlung zu folgenden Zwecken erhält, gemeinsam verantwortlich:  a) Anzeige von Inhalten sowie Werbeinformationen, die den mutmaßlichen Interessen der Nutzer entsprechen; b) Zustellung kommerzieller und transaktionsbezogener Nachrichten (z. B. Ansprache von Nutzern via Facebook-Messenger); c) Verbesserung der Anzeigenauslieferung und  Personalisierung von Funktionen und Inhalten (z. B. Verbesserung der Erkennung, welche Inhalte oder Werbeinformationen mutmaßlich den Interessen der Nutzer entsprechen). Wir haben mit Facebook eine spezielle Vereinbarung abgeschlossen ("Zusatz für Verantwortliche", <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://www.facebook.com/legal/controller_addendum" target="_blank" rel="noopener noreferrer">https://www.facebook.com/legal/controller_addendum</a>), in der insbesondere geregelt wird, welche Sicherheitsmaßnahmen Facebook beachten muss (<a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://www.facebook.com/legal/terms/data_security_terms" target="_blank" rel="noopener noreferrer">https://www.facebook.com/legal/terms/data_security_terms</a>) und in der Facebook sich bereit erklärt hat die Betroffenenrechte zu erfüllen (d. h. Nutzer können z. B. Auskünfte oder Löschungsanfragen direkt an Facebook richten). Hinweis: Wenn Facebook uns Messwerte, Analysen und Berichte bereitstellt (die aggregiert sind, d. h. keine Angaben zu einzelnen Nutzern erhalten und für uns anonym sind), dann erfolgt diese Verarbeitung nicht im Rahmen der gemeinsamen Verantwortlichkeit, sondern auf Grundlage eines Auftragsverarbeitungsvertrages ("Datenverarbeitungsbedingungen ", <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://www.facebook.com/legal/terms/dataprocessing" target="_blank" rel="noopener noreferrer">https://www.facebook.com/legal/terms/dataprocessing</a>) , der "Datensicherheitsbedingungen" (<a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://www.facebook.com/legal/terms/data_security_terms" target="_blank" rel="noopener noreferrer">https://www.facebook.com/legal/terms/data_security_terms</a>) sowie im Hinblick auf die Verarbeitung in den USA auf Grundlage von Standardvertragsklauseln ("Facebook-EU-Datenübermittlungszusatz, <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://www.facebook.com/legal/EU_data_transfer_addendum" target="_blank" rel="noopener noreferrer">https://www.facebook.com/legal/EU_data_transfer_addendum</a>). Die Rechte der Nutzer (insbesondere auf Auskunft, Löschung, Widerspruch und Beschwerde bei zuständiger Aufsichtsbehörde), werden durch die Vereinbarungen mit Facebook nicht eingeschränkt; <strong>Dienstanbieter:</strong> Meta Platforms Ireland Limited, Merrion Road, Dublin 4, D04 X2K5, Irland; <span><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); </span><strong>Website:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">https://www.instagram.com</a>. <strong>Datenschutzerklärung:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://privacycenter.instagram.com/policy/" target="_blank" rel="noopener noreferrer">https://privacycenter.instagram.com/policy/</a>.</li>
          <li><strong>X-Plugins und -Inhalte: </strong>Plugins und -Schaltflächen der Plattform "X" - Hierzu können z. B. Inhalte wie Bilder, Videos oder Texte und Schaltflächen gehören, mit denen Nutzer Inhalte dieses Onlineangebotes innerhalb von X teilen können; <strong>Dienstanbieter:</strong> Twitter International Company, One Cumberland Place, Fenian Street, Dublin 2 D02 AX07, Irland; <span><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); </span><strong>Website:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://x.com/de" target="_blank" rel="noopener noreferrer">https://x.com/de</a>; <strong>Datenschutzerklärung:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://x.com/de/privacy" target="_blank" rel="noopener noreferrer">https://x.com/de/privacy</a>, (Settings: <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://x.com/personalization" target="_blank" rel="noopener noreferrer">https://x.com/personalization</a>); <strong>Auftragsverarbeitungsvertrag:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://privacy.x.com/en/for-our-partners/global-dpa" target="_blank" rel="noopener noreferrer">https://privacy.x.com/en/for-our-partners/global-dpa</a>. <strong>Grundlage Drittlandtransfers:</strong> Standardvertragsklauseln (<a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://privacy.x.com/en/for-our-partners/global-dpa" target="_blank" rel="noopener noreferrer">https://privacy.x.com/en/for-our-partners/global-dpa</a>).</li>
          <li><strong>YouTube-Videos: </strong>Videoinhalte; <strong>Dienstanbieter:</strong> Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland; <span><strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6 Abs. 1 S. 1 lit. a) DSGVO); </span><strong>Website:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://www.youtube.com" target="_blank" rel="noopener noreferrer">https://www.youtube.com</a>; <strong>Datenschutzerklärung:</strong> <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy</a>; <strong>Grundlage Drittlandtransfers:</strong> Data Privacy Framework (DPF). <strong>Widerspruchsmöglichkeit (Opt-Out):</strong> Opt-Out-Plugin: <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://tools.google.com/dlpage/gaoptout?hl=de" target="_blank" rel="noopener noreferrer">https://tools.google.com/dlpage/gaoptout?hl=de</a>, Einstellungen für die Darstellung von Werbeeinblendungen: <a class="text-blue-400 break-all underline-offset-2 hover:underline" href="https://myadcenter.google.com/personalizationoff" target="_blank" rel="noopener noreferrer">https://myadcenter.google.com/personalizationoff</a>.</li>
        </ul>
      </section>

      <!-- Änderung und Aktualisierung -->
      <section class="space-y-3">
        <h3 id="m15" class="scroll-mt-6 text-xl font-semibold text-white">
          Änderung und Aktualisierung
        </h3>
